    ...
    for i in [1, 2, 3]:
        ...
        for ticker in ticker_list:
            ...
            #  except:
                ...
                #  rest_list.append(ticker)
        ticker_list = rest_list
    return result


def load_data(ema_period=[5, 5 * 5, 5 * 20], rsi_period=[14, 14 * 5],
              save_result=False,
              av_save="av_cooked",
